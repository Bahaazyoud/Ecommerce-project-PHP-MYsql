...
if(isset($_POST['update_profile'])){
   ...
   if(!empty($image)){
      if($image_size > 2000000){
         ...
         $update_image = $connection->prepare("UPDATE `user` SET url_image = ? WHERE user_id = ?");
...
<section class="update-profile">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      <img src="uploaded_img/<?= $fetch_profile['url_image']; ?>" alt="">
      <div class="flex">
         <div class="inputBox">
            <span>username :</span>
            ...
            <input type="hidden" name="old_image" value="<?= $fetch_profile['url_image']; ?>">
         </div>
         <div class="inputBox">
