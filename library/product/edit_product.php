...
<div id="app">
    ...
    <div class="container " style="width: 70%; margin-top:5%;" >
        <form action="../insert.php?mode=edit" method="post" style="margin: 20px 0;" enctype="multipart/form-data">
            ...
            <input type="text" class="form-control" id="product-name" placeholder="Name" name="product-name" value="<?php echo $data["name"]?>">
            <br>
            ...
            <input type="text" class="form-control" id="product_description" placeholder="description" name="product_description" value="<?php echo $data["description"]?>">
            <br>
