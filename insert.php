...
if(isset($_POST["category-name"])){
    ...
    try{
        ...
        if($image){
            ...
            $_POST["category-url_img"] = $image['name'];
        ...
        try{
            ...
            try{
              ...
              if($image["tmp_name"]){
                ...
                $sql = "UPDATE `user` SET `name` = :name, `url_image` = :url, `role` = :role, `email` = :email
  ...
  if($_SESSION["mode"] == "add"){
    ...
    if($_GET["mode"] == "add"){
        try{
            ...
            if($image){
                $location = 'library-origin/images/'.$image['name'];
            $_POST["product-url_img"] = $image['name'];
            move_uploaded_file($image['tmp_name'] , $location);
            }
            ...
            if(isset($_POST["product-order_id"]) && isset($_POST["product-cart_id"])){
                $sql = "INSERT INTO `product` (`product_id`, `product_name`, `category_id`, `price`, `url_image`, `order_id`, `cart_id`, `descreption`) 
        ...
        }else if(isset($_POST["product-cart_id"])){
            $sql = "INSERT INTO `product` (`product_id`, `product_name`, `category_id`, `price`, `url_image`, , `cart_id`, `descreption`) 
            VALUES (NULL, :name, :category, :price, :url_image,, :cart, :description_product)";
            $statement = $db->prepare($sql);
        if(!$statement->execute(array(
            ":name" => $_POST["product-name"],
            ":category" =>$_POST["product-category_data"],
        ...
        }else if(isset($_POST["product-order_id"])){
            $sql = "INSERT INTO `product` (`product_id`, `product_name`, `category_id`, `price`, `url_image`, `order_id`, `descreption`) 
            VALUES (NULL, :name, :category, :price, :url_image, :order, :cart, :description_product)";
            $statement = $db->prepare($sql);
        if(!$statement->execute(array(
            ":name" => $_POST["product-name"],
            ...
            $sql = "INSERT INTO `product` (`product_id`, `product_name`, `category_id`, `price`, `url_image`, `descreption`) 
            VALUES (NULL, :name, :category, :price, :url_image, :description_product)";
            $statement = $db->prepare($sql);
        if(!$statement->execute(array(
            ":name" => $_POST["product-name"],
            ":category" =>$_POST["product-category_data"],
    ...
    try{
        ...
        $sql = "UPDATE `product` SET `product_name` = :name, `category_id` = :category, `price` = :price, `url_image` = :url_image, `order_id` = :order , `cart_id` = :cart , `descreption` = :description_product
